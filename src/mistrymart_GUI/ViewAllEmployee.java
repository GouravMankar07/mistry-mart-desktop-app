...
public class ViewAllEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableAllReceptionist.setBackground(new java.awt.Color(255, 204, 204));
    ...
    private void showEmpData(){
     try {
        ...
        for (EmployeePOJO employeePOJO : empList) {
            rows[0]=employeePOJO.getEmpid();
            rows[1]=employeePOJO.getEmpname();
            rows[2]=employeePOJO.getJob();
            rows[3]=employeePOJO.getSalary();
            tm.addRow(rows);
        }
